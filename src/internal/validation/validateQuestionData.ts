import type { QuestionData } from "../../ingest/types.js";
import { ValidationError } from "../../types/errors.js";

export function validateQuestionData(qd: QuestionData, obsIndex: number): void {
  ...
  if (
    typeof qd.positionInSession !== "number" ||
    !Number.isInteger(qd.positionInSession) ||
    qd.positionInSession < 1 ||
    qd.positionInSession > 200
  ) {
    throw new ValidationError(
      prefix + ".positionInSession must be an integer between 1 and 200 inclusive",
    );
  }
