 ...
 */
export async function sessionSignal(params: SessionSignalParams): Promise<{ senecaUserId: string; sessionId: string | null }> {
  ...
  return gatewayPost<{ senecaUserId: string; sessionId: string | null }>(
    "ingest",
    "sessionSignal",
    { limbUserId, session },
  );
