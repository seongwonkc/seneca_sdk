import { UnauthorizedError, NotFoundError, ValidationError, ConflictError, RateLimitedError, TokenExpiredError, TokenSpentError, IdentityMismatchError, SenecaError, } from "../../types/errors.js";
function getEnv(key) {
...
export async function gatewayPost(surface, method, body) {
    ...
    try {
        ...
        throw new SenecaError("Gateway returned non-JSON response (HTTP " + res.status + ")", "INTERNAL", res.status);
    }
    if (!res.ok) {
